...
const meta = {
	description: `${process.env.NEXT_PUBLIC_NFT_NAME} is an NFT collection of 3,000 unique NFT`,
...
export default function Meta({ pageTitle }: Props) {
	...
	const ogTitle = pageTitle ? pageTitle : 'An NFT collection of 3,000 unique NFT'
	...
	return (
		<Head>
			...
			<meta property="og:site_name" content={process.env.NEXT_PUBLIC_NFT_NAME} />
			<meta property="og:title" content={ogTitle} />
			<meta property="og:description" content={meta.description} key="ogDescription" />
			<meta property="og:image" content={ogImage} key="ogImage" />
			<meta name="twitter:card" content="summary_large_image" />
			<meta name="twitter:site" content={process.env.NEXT_PUBLIC_TWITTER_USERNAME} />
		</Head>
	)
}
